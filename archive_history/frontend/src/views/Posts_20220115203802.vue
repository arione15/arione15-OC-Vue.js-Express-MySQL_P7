                ...
                <v-card outlined class="mx-auto" height="100%">
                  ...
                  <div>
                    <!-- <v-btn class="ma-2" text icon color="blue lighten-2">
                      ...
                      <!-- <div @click="likePost(post.id)" class="material-icons green-color">thumb_up</div> -->
                      ...
                      <!-- <span class="material-icons teal-color"> thumb_up</span> -->
                       <v-btn @click="likePost(post.id)" class="ma-2" text icon color="red lighten-2"><v-icon>mdi-thumb-down</v-icon></v-btn>
