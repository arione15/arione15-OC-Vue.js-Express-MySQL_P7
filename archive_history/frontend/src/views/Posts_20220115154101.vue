...
<v-row>
          <v-col v-for="post of posts" class="post" :key="post.id" cols="12">
          <v-card outlined class="mx-auto" height="100%">
            <v-img class="white--text align-end album-image" height="200px" width="100" :src="post.attachmentUrl"></v-img>
