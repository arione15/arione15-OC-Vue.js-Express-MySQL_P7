...
<div>
      ...
      <v-toolbar-items>
          <v-btn text dark ><span class="material-icons">thumb-up</span></v-btn>
        </v-toolbar-items>
<!-- 
      <v-btn
        class="ma-2"
              ...
              <div>
                ...
                <form action class>
                    ...
                    <div class="d-flex panel-footer form-group">
                      ...
                      <v-btn color="light-blue" class="mx-auto dark @click="publishComment(post.id)">Ajouter votre commentaire !!</v-btn>
                    </div>
                    </v-col>
                  </v-row>
