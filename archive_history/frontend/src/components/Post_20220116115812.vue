...
<v-card max-width="12800" class="mx-auto">
...
<v-navigation-drawer v-model="drawer">
      <v-sheet
        ...
        class="pa-4"
      >
        <v-avatar class="mb-4" color="grey darken-1" size="64"><img :src="post.User.photoUrl" alt="Avatar" /></v-avatar>
...
<v-list>
   <v-list-item v-for="comment in post.Comments" :key="comment.id">
      <v-list-item-content>
        ...
        <v-list-item-subtitle>{{ comment.User.firstName }}{{ comment.User.familyName }}</v-list-item-subtitle>
      </v-list-item-content>
    </v-list-item>
</v-list>
 </v-card>
