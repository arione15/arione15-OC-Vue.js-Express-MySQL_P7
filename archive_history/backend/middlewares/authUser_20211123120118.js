...
module.exports = (req, res, next) => {
    ...
    jwt.verify(token, process.env.SECRET_KEY, async(err, decodedToken)); // décoder le token à l'aide du code secret ==> le résultat du décodage est un objet js classique
