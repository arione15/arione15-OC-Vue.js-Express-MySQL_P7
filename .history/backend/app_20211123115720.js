...
app.use(cookieParser();
        ...
        require('./routes/posts/findAllPosts')(app); require('./routes/posts/findByPkPost')(app); require('./routes/posts/createPost')(app); require('./routes/posts/updatePost')(app); require('./routes/posts/deletePost')(app);

        require('./routes/users/login')(app); require('./routes/users/signup')(app); require('./routes/users/logout')(app);
        // TODO : 
