<template>
  <v-container class="d-flex flex-column pa-2">
    ...
    <v-app-bar color="light-blue accent-4" dense dark class="d-flex justify-start">
    ...
    <v-card-title class="white--text mt-8">
      ...
      <v-toolbar-title>Titre :{{ post.title }}</v-toolbar-title>
      <v-btn icon>
        ...
        <v-list>
          ...
          <v-list-item :to="{ name: 'Profil', params: { id: post.User.id } }">
            <v-list-item-title>View Profil</v-list-item-title>
                  ...
                  <v-img class="white--text align-end album-image" max-width="400px" max-height="300px" :src="post.attachmentUrl"></v-img>
