      ...
      <v-row>
        <v-col cols="10" v-for="post of posts" class="post" :key="post.id">
          <v-card outlined class="mx-auto" height="100%">
                    ...
                    <span class="post-modify" v-if="post.userId == post.User.id">Modifier</span> 
                </div>
            <v-img
            ...
            <form action class>
                  <div class="d-flex align-items-start flex-column form-group">
                    ...
                    <v-text-field required :rules="rules.required" label="Comment" v-model="post.Ccomment.message" multi-line></v-text-field>
                    </div>
                  <div class="d-flex panel-footer form-group">
