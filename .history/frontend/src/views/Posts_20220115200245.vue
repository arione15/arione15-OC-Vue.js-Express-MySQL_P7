  ...
  <v-app id="inspire" app>
    ...
    <!-- <v-main>
      ...
      >
        <v-row>
          <v-col
            v-for="post of posts" class="post" :key="post.id"
            cols="12"
          >
            <v-card>
                ...
                <v-card outlined class="mx-auto" height="100%">
                  ...
                  <div>
                    <!-- <v-btn class="ma-2" text icon color="blue lighten-2">
                      ...
                      <span v-for="like in post.Likeskes.includes($store.state.user.id)" class="material-icons green-color">thumb_up</span>
                      <span @click="likePost(post.id)" v-if="post.Likes.includes($store.state.user.id)" class="material-icons green-color">thumb_up</span>
...
export default {
  ...
  methods: {
    ...
    async get() {
      ...
      this.likes = this.posts.map(function(element){return element.Likes
      });
