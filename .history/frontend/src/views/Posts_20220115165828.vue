...
<img :src="post.User.photoUrl" alt="Avatar">
      ...
      <v-list>
        <v-list-item>
          ...
          <v-list-item-content>
            <v-list-item-title><v-btn color="#FD2D01" dark :to="{ name: 'Post', params: { postId: post.id } }">View Post</v-btn></v-list-item-title>
          </v-list-item-content>
          <v-list-item-content>
            <v-list-item-title><v-btn color="#FD2D01" dark :to="{ name: 'Profil', params: { id: post.User.id } }">View Profil</v-btn></v-list-item-title>
          </v-list-item-content>
        </v-list-item>
