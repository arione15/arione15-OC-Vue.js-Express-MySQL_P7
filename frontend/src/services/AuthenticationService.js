...
export default {
    ...
    loginUser(credentials) { // envoi les identifiants par post sur 3000 (serveur backend) et qui vont être récupérés dans app.js : app.post('/login', (req, res) ... où /signup est aussi sur 3000 et qui va envoyer vers le frontend : récuperer dans Login.vue await...)
